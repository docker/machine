...
func init() {
	Register("hpelinux", &RegisteredProvisioner{
		New: NewHPELinuxProvisioner,
	})
}

func NewHPELinuxProvisioner(d drivers.Driver) Provisioner {
	return &HPELinuxProvisioner{
		NewSystemdProvisioner("hpelinux", d),
	}
}

type HPELinuxProvisioner struct {
	SystemdProvisioner
}

func (provisioner *HPELinuxProvisioner) String() string {
	return "hpelinux"
}

func (provisioner *HPELinuxProvisioner) Package(name string, action pkgaction.PackageAction) error {
...
func (provisioner *HPELinuxProvisioner) dockerDaemonResponding() bool {
...
func (provisioner *HPELinuxProvisioner) Provision(swarmOptions swarm.Options, authOptions auth.Options, engineOptions engine.Options) error {
