...
// TODO un-hardcode these locations
var (
	vmrunbin    = "C:\\Program Files (x86)\\VMware\\VMware Workstation\\vmrun.exe"
	vdiskmanbin = "C:\\Program Files (x86)\\VMware\\VMware Workstation\\vmware-vdiskmanager.exe"
)
