...
- `--azure-subnet-prefix`: Private CIDR block. Used to create subnet if it does not exist. Must match in case subnet exists.
...
- `--azure-no-public-ip`: Do not create a public IP address for the machine (implies azure-use-private-ip).
