...
Options:
 ...
 - `--openstack-net-id` or `--openstack-net-name`:Identify the private network id the machine will be connected on. If your
    OpenStack project project contains only one private network it will be use automatically.
