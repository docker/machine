...
For a complete list of the `docker-machine` subcommands, see the [Docker Machine subcommand reference](/docs/reference).
...
* [Docker Machine driver reference](/docs/drivers)
* [Docker Machine subcommand reference](/docs/reference)
